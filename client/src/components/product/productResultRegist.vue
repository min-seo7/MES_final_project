...
const onRowSelect = async (event) => {
  ...
  const response = await axios.get(
    `/api/production/checkWoStatus?wo_no=${selectedData.wo_no}`
  );
  ...
  try {
    ...
    const insertedName = await axios.get(
      `/api/production/selectEname?wo_no=${selectedData.wo_no}&process_id=${selectedData.process}`
    );
    ...
    <div class="w-full flex justify-end gap-2">
      <div class="space-x-2">
        ...
        <Button
          ...
          rounded
          @click="registStartPerformance"
        />
        <Button
          label=" 작업종료 "
          class="text-xs px-2 py-1 h-[28px]"
          rounded
          @click="registEndPerformance"
        />
        <Button
          label=" 지시목록 "
          class="text-xs px-2 py-1 h-[28px]"
          rounded
          @click="openModal('orderList')"
          severity="help"
        />
        <Button
          label=" 초기화 "
      ...
      <div class="grid grid-cols-4 gap-4 items-center">
        ...
        <div class="col-span-1 flex items-center gap-2">
          ...
          <DatePicker
            ...
            showTime
            hourFormat="24"
            v-model="performanceInsStartDate"
          />
        </div>
        <div class="col-span-1 flex items-center gap-2">
    ...
    <div class="flex-grow overflow-y-auto">
      ...
      >
        ...
        >
          <template
            #body="{ data, field }"
            v-if="col.field === 'startDate' || col.field === 'endDate'"
          >
