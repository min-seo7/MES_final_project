...
<template>
    <div class="card w-full">
        <DataTable :value="dataRows" dataKey="id" scrollable scrollHeight="300px" tableStyle="min-width: 50rem" :selection="selection" @update:selection="$emit('update:selection', $event)">
