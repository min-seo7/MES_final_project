  ...
  try {
    ...
    const queryParams = {
      ...
      orderStatus: searchFilters.value.orderStatus
        ? orderStateMapReverse.value[searchFilters.value.orderStatus]
        : null,
    ...
    const response = await axios.get("/api/sales/delDateSearch", {
      params: queryParams,
    });
...
<template>
  <div>
    ...
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-2xl font-bold">주문내역</h1>
        ...
        <div class="flex flex-wrap gap-6 p-4">
          ...
          <div class="flex flex-col">
            ...
            <div class="flex flex-wrap gap-3">
              ...
              >
                <RadioButton
                  v-model="searchFilters.orderStatus"
