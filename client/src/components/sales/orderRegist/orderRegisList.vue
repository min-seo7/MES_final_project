                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <div class="flex items-center gap-2">
                                    <RadioButton v-model="ingredient" inputId="ingredient1" name="orderState" value="주문서등록" />
                                    <label for="ingredient1">주문서등록</label>
                                </div>
                                <div class="flex items-center gap-2">
                                    <RadioButton v-model="ingredient" inputId="ingredient2" name="orderState" value="생산대기" />
                                    <label for="ingredient2">생산대기</label>
                                </div>
                                <div class="flex items-center gap-2">
                                    <RadioButton v-model="ingredient" inputId="ingredient3" name="orderState" value="생산중" />
                                    <label for="ingredient3">생산중</label>
                                </div>
                                <div class="flex items-center gap-2">
                                    <RadioButton v-model="ingredient" inputId="ingredient4" name="orderState" value="품질검수완료" />
                                    <label for="ingredient4">품질검수완료</label>
                                </div>
                                <div class="flex items-center gap-2">
                                    <RadioButton v-model="ingredient" inputId="ingredient5" name="orderState" value="제품입고" />
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <div class="flex items-center gap-2">
                                    <RadioButton v-model="ingredient" inputId="ingredient1" name="spec" value="40" />
                                    <label for="ingredient1">40</label>
                                </div>
                                <div class="flex items-center gap-2">
                                    <RadioButton v-model="ingredient" inputId="ingredient2" name="spec" value="40" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <div class="flex items-center gap-2">
                                    <RadioButton v-model="ingredient" inputId="ingredient1" name="product" value="분쇄형" />
                                    <label for="ingredient1">분쇄형</label>
                                </div>
                                <div class="flex items-center gap-2">
                                    <RadioButton v-model="ingredient" inputId="ingredient2" name="product" value="과립형" />
                                    <label for="ingredient2">과립형</label>
                                </div>
                                <div class="flex items-center gap-2">
                                    <RadioButton v-model="ingredient" inputId="ingredient3" name="product" value="액상형" />
