...
<template>
  <div>
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-2xl font-bold">주문수정</h1>
    ...
    <div class="flex space-x-6">
      <div class="w-2/3">
        <br />
        <div class="font-semibold text-xl mb-4 mt-7">주문내역</div>
        <DataTable
        ...
        >
          <div class="grid grid-cols-1 gap-5">
            <div class="flex flex-col space-y-1">
              ...
              <InputText
                v-model="orderUpdate.originDeliveryDate"
                readonly
            ...
            <div class="flex flex-col space-y-1">
              ...
              <Calendar
                v-model="orderUpdate.changeDeliveryDate"
                dateFormat="yy-mm-dd"
                showIcon
              />
            </div>
            <div class="flex flex-col space-y-1">
              ...
              <InputText
                v-model="orderUpdate.changeReason"
                placeholder="자연재해 예정"
              />
            </div>
            <div class="flex flex-col space-y-1">
