            ...
            <div class="flex flex-col gap-4 w-full">
                ...
                <div>
                    ...
                    <label class="flex items-center border rounded cursor-pointer hover:bg-gray-100 px-3 h-[38px]">
                        <RadioButton id="status1" name="status" value="활성화" v-model="form.status" />
                        <label for="status1" class="ml-2 mr-4">활성화</label>
                        <RadioButton id="status2" name="status" value="비활성화" v-model="form.status" />
                        <label for="status2" class="ml-2 mr-4">비활성화</label>
                    </label>
                </div>
            </div>
