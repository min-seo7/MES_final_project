...
<template>
    <DataTable :value="items" :rowHover="true" class="bg-white rounded-md border" size="small" :scrollable="true" :scrollHeight="scrollHeight">
        <!-- 행 번호 -->
        <Column header="#" :body="(_, opt) => opt.rowIndex + 1" style="width: 60px; text-align: center" />
