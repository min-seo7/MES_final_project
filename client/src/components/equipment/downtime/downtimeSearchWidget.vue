    ...
    <div class="flex justify-start border p-4 rounded-md bg-white">
        <div class="flex items-center gap-2">
            ...
            <div class="relative w-80">
                ...
                <i class="pi pi-search absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-gray-500" @click="openPicker"></i>
            </div>
        </div>
    </div>

    <!-- 모달 -->
    <Dialog v-model:visible="showPicker" header="설비코드" modal :style="{ width: '30rem' }">
        <ul class="divide-y">
