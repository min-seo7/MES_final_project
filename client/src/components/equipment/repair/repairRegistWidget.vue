  ...
  <div class="mt-8 space-y-4 text-[14px]">
    ...
    <div class="border rounded-md overflow-hidden bg-white">
      <div class="grid grid-cols-[10rem_1fr_10rem_1fr] text-[14px]">
        <!-- 설비코드 -->
        <div
          class="bg-gray-50 border-r border-b px-3 py-4 font-medium flex items-center justify-center"
        >
        ...
        <!-- 수리코드 (자동생성) -->
        <div
          class="bg-gray-50 border-r border-b px-3 py-4 flex items-center justify-center font-medium text-[14px]"
        >
        ...
        <!-- 수리내용 -->
        <div
          class="bg-gray-50 border-r border-t px-3 py-4 font-medium flex items-center justify-center"
        >
          수리내용
        </div>
        <div class="col-span-3 border-t px-0 py-0">
          <div class="border-l border-r border-gray-300">
            <div
              class="grid bg-gray-50 font-medium border-b"
            ...
            <div
              class="grid items-center border-t"
              style="grid-template-columns: 1fr 1fr 1fr"
            >
    ...
    >
      <ul class="divide-y">
        ...
        <li v-if="!eqList.length" class="p-4 text-center text-gray-500">
          항목 없음
        </li>
      </ul>
