    ...
    return {
      ...
      pendingCol: [
        ...
        //{ field: 'p_exp', header: '유통기한', headerStyle: 'width: 20rem' },
        {
          ...
          headerStyle: "width: 20rem",
          inputTextWM: true,
          onClick: this.openWarehouseeModal,
        }, //창고위치모달.
        {
          field: "p_memo",
          header: "비고",
  ...
  methods: {
    ...
    onSelectonSelectPrd() {
      if (this.selectRow !== null) {
        //선택시.
        this.prdReceiptPending[this.selectRow].p_prdType =
          this.selectPrd.prdType;
        this.prdReceiptPending[this.selectRow].p_prdCode =
          this.selectPrd.prdCode;
        this.prdReceiptPending[this.selectRow].p_prdName =
          this.selectPrd.prdName;
      } else {
    ...
    onSelectWare() {
      this.prdReceiptPending[this.selectRow].p_warehouse =
        this.selectWare.warerName;
    ...
    dateFormat(date) {
      ...
      return (
        ...
        "-" +
        String(newDateFormat.getMonth() + 1).padStart(2, "0") +
        "-" +
        String(newDateFormat.getDate()).padStart(2, "0")
      );
    },
  },
  mounted() {
...
<template>
  <div>
    <div class="font-semibold text-2xl mb-4">제품 입고</div>
      ...
      <Tabs value="0">
        ...
        <TabPanels>
          <TabPanel value="0">
            ...
            <!--0번탭 컨텐츠영역-->
            <stockCommTable
              v-model:selection="selectPendingPrds"
              :columns="pendingCol"
              :dataRows="prdReceiptPending"
            />
          </TabPanel>
          <TabPanel value="1">
            ...
            <!--1번탭 컨텐츠영역-->
            <stockCommTable
              v-model:selection="selectPrdLots"
              :columns="ReceiptCol"
              :dataRows="prdReceipt"
            />
          </TabPanel>
