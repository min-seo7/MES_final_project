  ...
  methods: {
    ...
    async onSearch() {
      try {
        ...
        const res = await axios.post(
          "/api/stock/searchMatPandingList",
          filters
        );
        //조회결과
    ...
    onSelectMat() {
      if (this.selectRow !== null) {
        this.MatReceiptPanding[this.selectRow].p_matCode =
          this.selectMat.matCode;
        this.MatReceiptPanding[this.selectRow].p_matName =
          this.selectMat.matName;
    ...
    onSelectWare() {
      this.MatReceiptPanding[this.selectRow].p_warehouse =
...
<template>
  <div>
    <div class="font-semibold text-2xl mb-4">자재 입고</div>
      ...
      <Tabs value="0">
        ...
        <TabPanels>
          <TabPanel value="0">
            ...
            <!--0번탭 컨텐츠영역-->
            <stockCommTable
              v-model:selection="selectPandingMats"
              :columns="pandingCol"
              :dataRows="MatReceiptPanding"
            />
          </TabPanel>
          <TabPanel value="1">
            ...
            <!--1번탭 컨텐츠영역-->
            <stockCommTable
              v-model:selection="selectMatLots"
              :columns="ReceiptCol"
              :dataRows="MatReceipts"
            />
          </TabPanel>
        </TabPanels>
      </Tabs>
